...
#修改：邮箱更改odoo@example.com改为wsiicn@qq.com
ADMIN_EMAIL="wsiicn@qq.com"
##
...
WKHTMLTOX_X32=https://github.com/wkhtmltopdf/wkhtmltopdf/releases/download/0.12.6-1/wkhtmltox_0.12.6-1.trusty_i386.deb
#--------------------------------------------------
# Update Server
#--------------------------------------------------
echo -e "\n---- Update Server ----"
...
# libpng12-0更改为libpng-dev， libpng12-0 dependency for wkhtmltopdf
...
sudo apt-get install git python3 python3-pip build-essential wget python3-dev python3-venv python3-wheel libxslt-dev libzip-dev libldap2-dev libsasl2-dev python3-setuptools node-less libpng-dev libjpeg-dev gdebi -y
#增加库libpq-dev，否则按照requirements报错
